...
import { initializePool, queryEvents, formatPubkey } from "../../lib/nostrClient";
          ...
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    <span className="font-semibold text-gray-900">ผู้เขียนกระทู้</span>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: `<p class="mb-4">${renderContent(mainPost.content)}</p>` }}
            />
          ...
          <div className="divide-y divide-gray-200">
            ...
            {comments.length === 0 && (
              <div className="p-8 text-center text-gray-500">
                ...
                <p className="text-sm mt-2">เป็นคนแรกที่แสดงความคิดเห็นในกระทู้นี้</p>
              </div>
            )}
          </div>
        </div>
